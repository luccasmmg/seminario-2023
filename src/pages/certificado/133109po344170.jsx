export default function Certificado() {
 ...
 Certificamos que CARLOS ANDRé MACIEL PINHEIRO PEREIRA E AMANDA OLIVEIRA DA CâMARA MOREIRA apresentaram o pôster: "A QUESTÃO DA USURPAÇÃO DE COMPETÊNCIA: UMA ANÁLISE DAS MATERIAS PROCESSUAIS E PROCEDIMENTAIS NO CASO DE VIOLÊNCIA DOMÉSTICA (ADI 3.483/14) À LUZ DA JURISPRUDÊNCIA DO STF E DA DOUTRINA MINORITÁRIA" GT - JURISDIçãO CONSTITUCIONAL, recebendo o prêmio de melhor trabalho do respectivo GT, no XXI SEMINÁRIO DE PESQUISA DO CCSA - "CIDADANIA EM TEMPOS DE INTOLERÂNCIA", realizada no Centro de Ciências Sociais Aplicadas da Universidade Federal do Rio Grande do Norte.
	    		    </p>
